...
public class DeliveryCardTest {
    ...
    void shouldSuccessfulPlanAndReplanMeeting() {
        var validUser = DataClass.Registration.generateUser("ru");
        var daysToAddForFirstMeeting = 4;
        var firstMeetingDate = DataClass.generateDate(daysToAddForFirstMeeting);
        var daysToAddForSecondMeeting = 7;
        var secondMeetingDate = DataClass.generateDate(daysToAddForSecondMeeting);
    ...
    void shouldTestEnglishCity() {
        var validUser = DataClass.Registration.generateUser("en");
    ...
    void shouldTestEnglishName() {
        ...
        $("[placeholder=\"Город\"]").val(validUser.getCity());
        $("[placeholder=\"Дата встречи\"]").doubleClick().sendKeys(firstMeetingDate);
        $("[data-test-id=\"name\"] input.input__control").val(DataClass.generateName("en"));
        $("[name=\"phone\"]").setValue(validUser.getPhone());
        $("[data-test-id=\"agreement\"] .checkbox__box").click();
        $("[type=button] .button__text").click();
    ...
    void shouldTestOtherPhoneNum() {
        ...
        $("[placeholder=\"Дата встречи\"]").doubleClick().sendKeys(firstMeetingDate);
        $("[data-test-id=\"name\"] input.input__control").val(validUser.getName());
        $("[name=\"phone\"]").setValue(DataClass.generatePhone("cn"));
        $("[data-test-id=\"agreement\"] .checkbox__box").click();
        $("[type=button] .button__text").click();
        SelenideElement cityError = $("[data-test-id=\"city\"].input_invalid .input__sub");
